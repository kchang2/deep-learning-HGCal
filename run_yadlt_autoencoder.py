...
flags.DEFINE_string('save_reconstructions', 'hello.npy', 'Path to a .npy file to save the reconstructions of the model.')
flags.DEFINE_string('save_parameters', 'hello2.npy', 'Path to save the parameters of the model.')
